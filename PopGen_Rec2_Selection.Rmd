...
calc_p_t1 = function( p, s ){
  q=1-p
  num=p^2+(p*q) #QUESTION 1: What should this code be?, why?
  dem=p^2+(2*p*q)+(q^2*(1-s))    #QUESTION 2: What should this code be? why?
  p_t1 = num/dem
  return(p_t1)
...
p_results = calc_p_t1(p, s_values) #QUESTION 3: What should these parameters be?
