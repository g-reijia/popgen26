---
title: "Recitation 6 – Linked selection"
author: "Rei Jia"
date: "2026-04-07"
...
```{r}
selection_rate = function( p, h, s ){
q=(1-p)
num=p*q*s*(p*h+(q*(1-h)))
dem=1-(2*p*q*h*s)-(q^2*s)
p_t1=num/dem
return(p_t1)
}
```
...
# Evaluate selection
pa_delta = selection_rate(pa_recur[g-1], h, s)
...
<<QUESTION 5: As we mentioned in the lecture, a more common metric use to measure linkage is r^2, defined as:
